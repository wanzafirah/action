...
def _render_overdue_alert(meetings: list) -> None:
    ...
    header = (
        ...
        "<th style='padding:0.45rem 0.6rem;text-align:left;color:#7f1d1d;font-weight:800'>MEETING</th>"
    ...
    for i, r in enumerate(overdue_rows, 1):
        ...
        rows_html += (
            ...
            f"<td style='padding:0.45rem 0.6rem;color:#374151;font-size:0.79rem;font-style:italic'>{r['mtitle']}</td>"
...
def _render_upcoming(meetings: list) -> None:
    ...
    for i, r in enumerate(action_rows, 1):
        ...
        rows_html += (
            ...
            f"<td style='padding:0.45rem 0.6rem;color:#64748b;font-size:0.79rem;font-style:italic'>{r['meeting_title']}</td>"
